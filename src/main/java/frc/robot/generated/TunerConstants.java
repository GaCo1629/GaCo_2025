...
public class TunerConstants {
	...
	private static final double fineTune = 1.01225;
	private static final double kDriveGearRatio = 6.394736842105262 * fineTune;
	...
	// Scroll down and read the value for : "Absolute Position NO Offset" <<<  make sure you use the
	// correct item.
	// Flip the sign of the number shown   eg: flip + & -
	// Copy the flipped value into the "kXxxxxXxxxxEncoderOffset" value below in the corect wheel
	// location
	...
	private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.460938); // enter -ve value of
	...
	private static final Angle kFrontRightEncoderOffset = Rotations.of(0.351562);
	...
	private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.485107);
	...
	private static final Angle kBackRightEncoderOffset = Rotations.of(0.023682);

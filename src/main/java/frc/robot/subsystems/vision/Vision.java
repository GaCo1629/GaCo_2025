  ...
  public void periodic() {
    ...
    for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
      ...
      for (int tagId : inputs[cameraIndex].tagIds) {
        var tagPose = Constants.kFieldLayout.getTagPose(tagId);
      ...
      for (var observation : inputs[cameraIndex].poseObservations) {
        ...
        boolean rejectPose = 
              !safetyOverride 
                ...
                || observation.pose().getX() > Constants.kFieldLayout.getFieldLength()
                || observation.pose().getY() < 0.0
                || observation.pose().getY() > Constants.kFieldLayout.getFieldWidth();

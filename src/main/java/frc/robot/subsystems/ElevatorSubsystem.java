...
public class ElevatorSubsystem extends SubsystemBase {
	...
	private final SysIdRoutine m_sysIdRoutine = new SysIdRoutine(
			new SysIdRoutine.Config(Volts.of(0.5).per(Seconds), Volts.of(2), Seconds.of(5), null),
					...
					log -> {
						...
						log.motor("elevator")
								...
								.angularPosition(m_distance.mut_replace(
										m_centerElevatorMotor.getEncoder().getPosition(), Rotations))
								.angularVelocity(m_velocity.mut_replace(
										m_centerElevatorMotor.getEncoder().getVelocity(), RotationsPerSecond));
					},
					this));

	/** Creates a new ElevatorSubsystem. */
	public ElevatorSubsystem() {
		m_leftElevatorMotor = new SparkFlex(Elevator.kElevatorMotorLeftId, MotorType.kBrushless);
		m_centerElevatorMotor = new SparkFlex(Elevator.kElevatorMotorCenterId, MotorType.kBrushless);
		m_rightElevatorMotor = new SparkFlex(Elevator.kElevatorMotorRightId, MotorType.kBrushless);
		...
		m_leftElevatorMotor.configure(
				m_leftElevatorMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
		m_centerElevatorMotor.configure(
				m_centerElevatorMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
		m_rightElevatorMotor.configure(
				m_rightElevatorMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
	}
